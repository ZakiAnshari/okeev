                            ...
                            <div class="modal fade" id="addCarModal" tabindex="-1" aria-labelledby="addCarModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <hr>
                                        <form action="{{ route('features.store', $electric_car->id) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                    ...
                                    @forelse ($features as $item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <!-- Edit -->
                                                <a href="{{ route('features.edit', [$electric_car->id, $item->id]) }}" 
                                                class="btn btn-icon btn-outline-primary">
                                                        <i class="bx bx-edit-alt"></i>
                                                </a>
                                                <!-- Delete -->
                                                <a href="javascript:void(0)" onclick="confirmDeleteFeatureCar({{ $electric_car->id }}, {{ $item->id }}, '{{ $item->name }}')">
...
<script>
    function confirmDeleteFeatureCar(electricCarId, technologyId, name) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = `/cars/${electricCarId}/features/${technologyId}`;
            }
        });
    }
</script>
