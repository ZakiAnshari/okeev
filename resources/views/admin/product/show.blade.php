        ...
        <div class="card-body">
            <div class="text-nowrap">
                <div class="row">
                    ...
                    <div class="modal fade" id="technologyModal" tabindex="-1" aria-labelledby="addCarModalLabel" aria-hidden="true">
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <small class="text-muted d-block mt-1">
                                                                Format yang diizinkan: <strong>PNG, JPG, JPEG</strong> — Maksimal <strong>2 MB</strong>
                                                            </small>
                    ...
                    <div class="modal fade" id="FeatureModal" tabindex="-1" aria-labelledby="addCarModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                        <!-- Header -->
                                <div class="modal-header">
                    ...
                    <div class="modal fade" id="ColorModal" tabindex="-1" aria-labelledby="addCarModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                        <!-- Header -->
                                <div class="modal-header">
                                ...
                                <div class="text-center mt-4">
                                    <div class="d-flex justify-content-center align-items-center mb-3" style="gap:10px;">
                                        ...
                                        <button class="btn btn-sm btn-outline-primary"
                                                data-bs-target="#productAvatarCarousel"
                                                data-bs-slide="prev">
                                            ‹
                                        </button>
                                        <!-- Carousel Box -->
                                        <div id="productAvatarCarousel" class="carousel slide"
                                            style="width:150px; height:150px; border-radius:11px; overflow:hidden; background:#f8f9fa;">
                                            <div class="carousel-inner d-flex align-items-center" style="height:150px;">
                    ...
                    <div class="col-lg-8">
                            <div class="nav-align-top mb-4">
                                ...
                                <div class="tab-content">
                                    {{-- TEKNOLOGI TABLE --}}
                                    <div class="tab-pane fade {{ $activeTab == 'technology' ? 'show active' : '' }}" id="navs-pills-top-home" role="tabpanel">
                                        <table class="table table-bordered">
                                            ...
                                            @forelse ($technologies as $item)
                                                <tr>
                                                    <td>{{ ($technologies->currentPage() - 1) * $technologies->perPage() + $loop->iteration }}</td>
                                                    <td>{{ $item->name }}</td>
                                    ...
                                    {{-- FEATURE  TABLE --}}
                                    <div class="tab-pane fade {{ $activeTab == 'feature' ? 'show active' : '' }}" id="navs-pills-top-profile" role="tabpanel">
                                        <table class="table table-bordered">
                                            <thead>
                                                <tr>
                                                    <th style="width: 5px;">No</th>
