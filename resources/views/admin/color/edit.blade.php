    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            ...
            <div class="d-flex align-items-center border-bottom pb-2 mb-3">
                <a class="mx-4 my-4" href="{{ route('product.show', $product->slug) }}?tab=color">
            ...
            <div class="card-body">
                <div class="text-nowrap">
                    ...
                    @endif
                    <form action="{{ route('colors.update', [$product->slug, $colors->id]) }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="color" name="hex" id="colorPicker"
                                        class="form-control form-control-color" value="{{ old('hex', $colors->hex) }}"
                                        title="Pilih warna">
