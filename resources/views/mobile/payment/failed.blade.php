...
@section('content')
    ...
    <div class="mobile-header">
        ...
        <div class="container header-container d-flex align-items-center py-3">
            ...
            <div class="mobile-header-title fw-semibold fs-5">Pembayaran Gagal</div>
        </div>
    </div>
    <br><br>
        ...
        <div class="d-flex justify-content-center">
            <div class="payment-card shadow-sm w-100" style="max-width:480px">
                ...
                <div class="text-center mb-4">
                    <div style="width: 80px; height: 80px; margin: 0 auto; background: #f8d7da; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                ...
                <!-- Failed Message -->
                <div class="text-center mb-4">
                    <h4 class="fw-bold text-danger">Pembayaran Gagal!</h4>
                    <p class="text-muted small">Pembayaran tidak berhasil atau dibatalkan</p>
                </div>
                ...
                <div class="bg-light p-3 rounded mb-4">
                    <p class="small mb-0">Silakan coba lagi atau hubungi admin jika mengalami masalah.</p>
                </div>
