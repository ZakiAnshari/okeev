...
@section('content')
    ...
    <nav class="navbar-custom-vehicle">
        <div class="navbar-top">
            ...
            <div class="search-box">
                <form action="{{ route('search.index') }}" method="GET" style="width: 100%; display: flex; align-items: center;">
                    ...
                    <input type="text" name="q" placeholder="Search in Cars" style="flex: 1; border: none; background: transparent; outline: none; padding-left: 8px;">
                </form>
            </div>
        ...
        <div>
            <h1 class="title-text m-0">Find Your Perfect Car at OKEEV</h1>
            <p class="subtitle-text">Explore a wide selection of quality vehicles tailored to your needs.</p>
        </div>
