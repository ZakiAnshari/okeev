...
@section('content')
    ...
    <section>
        <div class="container my-5">
            <div class="row">
                <!-- Back -->
                <a href="/cart" class="text-decoration-none d-flex align-items-center mb-4">
                    <i class="bx bx-arrow-back me-2"></i> Checkout
                </a>
                <!-- Shipping & Product -->
                <div class="col-lg-8">

                    <!-- Shipping Address -->
                    <div class="card mb-4 shipping-card">
                        <h6><strong>Shipping address</strong></h6>

                        <hr>
                        <div class="d-flex">
                            <img src="{{ asset('front_end/assets/images/gridicons_location.png') }}" alt="Location"
                                class="location-icon me-2" style="width:16px; height:16px;">

                            <div>
                                <p class="mb-1 fw-semibold">Home - Okeev</p>
                                <p class="text-muted mb-0">
                                    Jl. Ahmad Yani, Blog 66 17 Lorem ipsum dolor sit amet consectetur.
                                    Ornare volutpat nulla commodo venenatis.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mb-4 product-card">
                        <div class="d-flex">
                            ...
                            <!-- Content -->
                            <div class="flex-grow-1 product-content">
                                ...
                                <div class="product-header">
                                    ...
                                    <p class="text-muted small mb-2">
                                        ...
                                        Nunc congue varius nisl nulla fames.
                                    </p>

                                    <h6 class="text-danger fw-bold product-price">
                                        Rp 14.999.000
                                    </h6>
                                </div>
                        ...
                        <!-- DROPDOWN -->
                        <div class="shipping-options" style="margin: 0px 0px 0px 0px">
                            <select class="form-select mb-2 w-100">
                                <option>Regular</option>
                            </select>

                            <select class="form-select mb-1 w-100">
                                <option>J&T (Rp 10.000)</option>
                            </select>

                            <small class="text-muted">
                                Estimasi tiba besok - 27 Nov
                            </small>
                        </div>
