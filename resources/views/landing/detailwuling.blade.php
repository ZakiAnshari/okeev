        ...
        <div class="row g-4 mt-2 align-items-start">
            ...
            <div class="col-12 col-lg-4">
                <div class="thumb-container">
                    ...
                    <img src="{{ asset('front_end/assets/images/interior-trim-2 1.png') }}"
...
<section class="py-5">
    <div class="container">
        ...
        <div class="row align-items-center g-4 mt-1">
            ...
            <!-- Right Image -->
            <div class="col-lg-6 col-md-12">
                <img src="front_end/assets/images/Easy_to_Drive 1.png"
                     class="img-fluid rounded shadow-sm tech-image"
...
<section class="py-5">
    <div class="container">
        ...
        <div class="row align-items-center g-4 mt-1">
            ...
            <!-- Right Image -->
            <div class="col-lg-6 col-md-12">
                <img src="front_end/assets/images/battery 1.png"
                    class="img-fluid rounded shadow-sm tech-image"
                    alt="Technology Image">
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row align-items-center g-4">
            ...
            <div class="col-lg-7 text-center">
                <img src="front_end/assets/images/Pristine_White 1.png"
